...
- [ ] Boottest (User): Display, Touch ok, S-Pen ok, Pogo ok (EF-DT730 erkannt, Key-Events sauber), Charge/AFC, Audio, Cam, Sensoren ok (Autorotation; lsm6dso/ak0991x/VEML3235/A96T3X6 + Samsung-Virtuals aktiv), 5G(LTE laeuft), WLAN ok (kein NFC-Modul in diesem Geraet)
